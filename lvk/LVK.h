...
class ICommandBuffer {
 public:
  ...
  virtual void cmdTransitionToGeneral(const lvk::Span<TextureHandle>& textures, const lvk::StageAccess& extraDstAccess) const = 0;
  virtual void cmdTransitionToShaderReadOnly(const lvk::Span<TextureHandle>& textures, const lvk::StageAccess& extraDstAccess) const = 0;
  ...
  virtual void cmdBindIndexBuffer(BufferHandle indexBuffer, VkIndexType indexType, uint64_t bufferOffset = 0, uint64_t bufferSize = VK_WHOLE_SIZE) = 0;
