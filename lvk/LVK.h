...
class ICommandBuffer {
 public:
  ...
  virtual void cmdSetFragmentShadingRate(const Dimensions& fragmentSize, // 2D, e.g. 1x1 (full rate) or 2x2
                                         VkFragmentShadingRateCombinerOpKHR primitiveOp = VK_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_KHR,
                                         VkFragmentShadingRateCombinerOpKHR attachmentOp = VK_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_KHR) = 0;
