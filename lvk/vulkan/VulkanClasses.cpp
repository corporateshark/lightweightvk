...
void lvk::CommandBuffer::cmdTransitionLayout(const ldr::Span<TextureHandle>& textures,
  ...
  for (TextureHandle handle : textures) {
    ...
    if (newLayout == VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL) {
      ...
      tex.transitionLayout(wrapper_->cmdBuf_, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, range, extraDstAccess);
    ...
    tex.transitionLayout(wrapper_->cmdBuf_, VK_IMAGE_LAYOUT_GENERAL, range, extraDstAccess);
    tex.ownerQueueFamily_ = queueFamilyIndex_;
